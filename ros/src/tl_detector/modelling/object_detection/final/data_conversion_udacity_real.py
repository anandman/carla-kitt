'''
Usage: python data_conversion_udacity_real.py --input_path input.yaml --output_path output_file_name.record
'''
import sys
import os
...
def main(_):
    ...
    for i in range(len(examples)):
        examples[i]['filename'] = os.path.abspath(os.path.join(
            os.path.dirname(FLAGS.input_path), examples[i]['filename']))
