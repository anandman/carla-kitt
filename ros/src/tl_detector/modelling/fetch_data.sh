...
python ./object_detection/final/data_conversion_bosch.py --input_path "$SCRIPTPATH/../data/bosch/test.yaml" --output_path "$SCRIPTPATH/../data/bosch/converted_labels/test.record"
python ./object_detection/final/data_conversion_bosch.py --input_path "$SCRIPTPATH/../data/bosch/train.yaml" --output_path "$SCRIPTPATH/../data/bosch/converted_labels/train.record"
